...
<style>
  ...
  <body>
    <center>
       <h1 style="margin-top:20px" class="font-weight-bold">Form Tanah</h1>
    </center>

    <div class="container" style="width:75%; margin:auto; margin-top:50px">
    <table class="table table-striped table">
      <form action="/form/tanah" method="POST" enctype="multipart/form-data" name="form" onsubmit="return validateForm()">
        {{ csrf_field() }}
            <div class="form-row">
              ...
              <tr><div class="form-input col-md-4" >
              ...
              <tr><div class="form-input" >
                ...
                <td colspan="3"><input type="text" class="form-control @error('Luas') is-invalid @enderror" id="Luas" name="Luas" placeholder="Luas(m2)" value="{{ old('Luas') }}" autocomplete="Luas" autofocus>
                @error('Luas')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input" >
                ...
                <td colspan="3"><input type="text" class="form-control @error('Tahun') is-invalid @enderror" id="Tahun" name="Tahun" placeholder="Tahun Pengadaan" value="{{ old('Tahun') }}" autocomplete="Tahun" autofocus>
                @error('Tahun')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input" >
                ...
                <td colspan="3"><input type="text" class="form-control @error('Alamat') is-invalid @enderror" id="Alamat" name="Alamat" placeholder="Letak/Alamat" value="{{ old('Alamat') }}" autocomplete="Alamat" autofocus>
                @error('Alamat')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input col-md-2" >
                ...
                <td><input type="text" class="form-control @error('StatusHak') is-invalid @enderror" id="StatusHak" name="StatusHak" placeholder="Hak" value="{{ old('StatusHak') }}" autocomplete="StatusHak" autofocus>
                @error('StatusHak')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                @enderror</td>
                <td><input type="date" class="form-control @error('SertifTgl') is-invalid @enderror" id="SertifTgl" name="SertifTgl" placeholder="Tanggal" value="{{ old('SertifTgl') }}" autocomplete="SertifTgl" autofocus>
                @error('SertifTgl')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                @enderror</td>
                <td><input type="number" class="form-control @error('SertifNo') is-invalid @enderror" id="SertifNo" name="SertifNo" placeholder="Nomor" value="{{ old('SertifNo') }}" autocomplete="SertifNo" autofocus>
                @error('SertifNo')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input" >
                ...
                <td colspan="3"><input type="text" class="form-control @error('Penggunaan') is-invalid @enderror" id="Penggunaan" name="Penggunaan" placeholder="Penggunaan" value="{{ old('Penggunaan') }}" autocomplete="Penggunaan" autofocus>
                @error('Penggunaan')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
