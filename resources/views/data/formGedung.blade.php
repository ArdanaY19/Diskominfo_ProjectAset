...
<style>
  ...
  <body>
    <center>
       <h1 style="margin-top:20px" class="font-weight-bold">Form Gedung dan Bangunan</h1>
    </center>

    <div class="container" style="width:75%; margin:auto; margin-top:50px">
    <table class="table table-striped table">
      <form action="/form/gedung" method="POST" enctype="multipart/form-data" name="form" onsubmit="return validateForm()">
        {{ csrf_field() }}
            <div class="form-row">
              ...
              <tr><div class="form-input">
                ...
                <td colspan="3"><input type="text" class="form-control @error('KondisiBgn') is-invalid @enderror" id="KondisiBgn" name="KondisiBgn" placeholder="Kondis Bangunan (B,KB,RB)" value="{{ old('KondisiBgn') }}" autocomplete="KondisiBgn" autofocus>
                @error('KondisiBgn')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input">
                ...
                <td colspan="2"><input type="text" class="form-control @error('KBTingkat') is-invalid @enderror" id="KBTingkat" name="KBTingkat" placeholder="Tingkat" value="{{ old('KBTingkat') }}" autocomplete="KBTingkat" autofocus>
                @error('KBTingkat')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
                @enderror</td>
                <td><input type="text" class="form-control @error('KBPondasi') is-invalid @enderror" id="KBPondasi" name="KBPondasi" placeholder="Pondasi" value="{{ old('KBPondasi') }}" autocomplete="KBPondasi" autofocus>
                @error('KBPondasi')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input">
                ...
                <td colspan="3"><input type="number" class="form-control @error('LuasLt') is-invalid @enderror" id="LuasLt" name="LuasLt" placeholder="Luas Lantai (M2)" value="{{ old('LuasLt') }}" autocomplete="LuasLt" autofocus>
                @error('LuasLt')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input">
                ...
                <td colspan="3"><input type="text" class="form-control @error('Alamat') is-invalid @enderror" id="Alamat" name="Alamat" placeholder="Letak / Lokasi Alamat" value="{{ old('Alamat') }}" autocomplete="Alamat" autofocus>
                @error('Alamat')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input">
                ...
                <td colspan="3"><input type="text" class="form-control @error('StatusTanah') is-invalid @enderror" id="StatusTanah" name="StatusTanah" placeholder="Status Tanah" value="{{ old('StatusTanah') }}" autocomplete="StatusTanah" autofocus>
                @error('StatusTanah')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
              ...
              <tr><div class="form-input">
                ...
                <td colspan="3"><input type="text" class="form-control @error('JumlahGd') is-invalid @enderror" id="JumlahGd" name="JumlahGd" placeholder="Jumlah Gedung" value="{{ old('JumlahGd') }}" autocomplete="JumlahGd" autofocus>
                @error('JumlahGd')
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $message }}</strong>
                </span>
             ...
             <tr><div class="form-input">
              ...
              <!-- <tr><div class="form-input">
                ...
                <td colspan="3"><input type="text" class="form-control @error('CekKecocokanKode') is-invalid @enderror" id="CekKecocokanKode" name="CekKecocokanKode" placeholder="CEK KECOCOKAN KODE LAMA DAN KODE TERBARU" value="{{ old('CekKecocokanKode') }}" autocomplete="CekKecocokanKode" autofocus>
